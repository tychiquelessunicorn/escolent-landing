      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center max-w-3xl mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
            Academic struggle is rarely intellectual; it begins as emotional overwhelm. Escolent gives students a safe, private way to reach out and connects them directly to human care.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="mt-6 space-y-5">
                <div className="p-4 rounded-[14px] bg-[var(--bg-surface-elevated)] border border-[var(--border-subtle)]">
                  ...
                  <div className="text-sm text-[var(--text-primary)] mt-1 font-medium">
        ...
        <div className="w-full max-w-5xl grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 sm:p-7 rounded-[22px] bg-[var(--bg-surface)] border border-[var(--border-subtle)] flex flex-col justify-between">
            <div>
              ...
              <p className="text-xs text-[var(--text-secondary)] mt-2.5 leading-relaxed">
                When a student reaches out or is flagged, the dashboard clearly displays whether another staff member has already opened or acknowledged the escalation. Shared responsibility never quietly becomes nobody's responsibility.
              </p>
            </div>
            <div className="mt-5 pt-4 border-t border-[var(--border-subtle)] text-[11px] text-[var(--brand-text)] font-medium">
              Clear accountability across grade and subject teams.
            </div>
          </div>
        </div>
      </div>
