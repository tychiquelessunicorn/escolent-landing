...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "pedagogical lead curriculum intelligence",
    "diagram OCR educational parsing",
    "cross-school curriculum coverage analytics",
    "curriculum graph authoring studio",
    "South Africa EdTech",
...
export default function RootLayout({
  ...
  const softwareSchema = {
    ...
    featureList: [
      ...
      "Pedagogical Lead Briefing & Cross-School Coverage Analytics",
      "Automated Canvas LMS Ingestion & Diagram OCR Parsing",
      "Diagnostic Skill Graph Authoring & Misconception Taxonomies",
      "LTI 1.3 Advantage Portal Integration (Canvas, Google Classroom, Moodle)",
      "Offline & Low-Connectivity Resilience",
      "Strict Data Sovereignty, Zero-PII Firewalls & 72-Hour Hold Vault",
